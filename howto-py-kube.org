...
#+BEGIN_SRC sh :results verbatim raw
kubectl scale rc greet --replicas=2
#+END_SRC
...
#+BEGIN_SRC sh :results verbatim raw
eval $(minikube docker-env) && docker build -t demo/greet-api:v2 app
#+END_SRC
...
#+BEGIN_SRC sh :results verbatim raw
kubectl rolling-update greet --image=demo/greet-api:v2 
#+END_SRC
...
#+NAME: clean_repo
#+BEGIN_SRC sh :tangle scripts/clean_repo.sh :results verbatim raw
rm -rf app scripts
rm -f *.html *.pdf *.tex
#+END_SRC
